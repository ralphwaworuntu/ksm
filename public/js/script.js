(function($) {
	...
	if($('.cs-countdown').length){
	   ...
	   $('.cs-countdown').countdown('').on('update.countdown', function(event) {
		  var $this = $(this).html(event.strftime('<div><span>%m</span><h6>Bulan</h6></div> <div><span>%D</span><h6>Hari</h6></div> <div><span>%H</span><h6>Jam</h6></div> <div><span>%M</span><h6>Menit</h6></div> <div><span>%S</span><h6>Detik</h6></div>'));
		});
	}
