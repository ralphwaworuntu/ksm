...
<head> 
	...
	<title>KSM - Gaming Solution | Manage Event</title> 
    ...
    <div class="wrapper theme-6-active pimary-color-pink">
		...
		<div class="fixed-sidebar-left">
			<ul class="nav navbar-nav side-nav nicescroll-bar">
					...
					<li>
						<a href="{{route('home-dashboard')}}" data-toggle="collapse" data-target="#dashboard_dr"><div class="pull-left"><i class="fa fa-tachometer mr-20"></i><span class="right-nav-text">Dashboard</span></div><div class="clearfix"></div></a>
            ...
            <div class="container-fluid pt-25">
				...
				<div class="row heading-bg">
					<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
					  <h5 class="txt-dark">Kelola Event</h5>
					</div>
					<!-- Breadcrumb -->
					<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
					  <ol class="breadcrumb">
						<li><a href="{{route('home-dashboard')}}">Dashboard</a></li>
						<li class="active"><span>Kelola Event</span></li>
					  </ol>
					</div>
					<!-- /Breadcrumb -->
				</div>
							...
							<div class="panel-wrapper collapse in">
								<div class="panel-body">
									<div  class="panel-body">
										...
										<button class="btn btn-info btn-rounded btn-anim img-responsive model_img"  alt="default" data-toggle="modal" data-target=".bs-example-modal-sm"><i class="ti ti-plus"></i><span class="btn-text">Tambah Event</span> </button>
									</div>
