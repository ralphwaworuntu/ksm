...
<head> 
	...
	<title>KSM - Gaming Solution | Add Event</title> 
...
<body>
    ...
    <div class="wrapper theme-6-active pimary-color-pink">
		...
		<div class="fixed-sidebar-left">
			<ul class="nav navbar-nav side-nav nicescroll-bar">
				...
				<li>
					<a  href="{{route('home-dashboard')}}" data-toggle="collapse" data-target="#dashboard_dr"><div class="pull-left"><i class="fa fa fa-tachometer mr-20"></i><span class="right-nav-text">Dashboard</span></div><div class="clearfix"></div></a>
					
				</li>
				<li>
					<a class="active" href="{{route('home-dashboard-event')}}" data-toggle="collapse" data-target="#ecom_dr"><div class="pull-left"><i class="fa fa-calendar mr-20"></i><span class="right-nav-text">Event</span></div><div class="clearfix"></div></a>
				</li>
            ...
            <div class="container-fluid pt-25">
				...
				<div class="row heading-bg">
					<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
						<h5 class="txt-dark">Tambah Event</h5>
					</div>
					...
					<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
						<ol class="breadcrumb">
							...
							<li><a href="{{route('home-dashboard-event')}}"><span>Kelola Event</span></a></li>
							<li class="active"><span>Tambah Event</span></li>
						</ol>
					</div>
					<!-- /Breadcrumb -->
							...
							<div class="panel-wrapper collapse in">
								<div class="panel-body">
									<form id="example-advanced-form" action="#">
										<h3><span class="number"><i class="icon-calender txt-black"></i></span><span class="head-font capitalize-font">Data Event</span></h3>
										<fieldset>
											<div class="row">
												<div class="col-sm-6 col-md-12">
													<div class="form-wrap">
														<div class="form-group">
															<label class="control-label mb-10" for="exampleInputuname_1">Nama Event</label>
															<div class="input-group">
																<div class="input-group-addon"><i class="zmdi zmdi-calendar"></i></div>
																<input type="text" class="form-control" id="exampleInputuname_1" placeholder="Nama Event">
															</div>
														</div>
														<div class="form-group">
															<label class="control-label mb-10">Pilih Game</label>
														...
														<div class="form-group">
															<label class="control-label text-left">Date Range Pick</label>
															<input class="form-control input-daterange-datepicker" type="text" name="daterange" value="01/01/2016 - 01/31/2016"/>
														</div>
														<div class="form-group">
															<label class="control-label mb-10">Pilih Kota/Kabupaten</label>
															<select class="selectpicker" data-style="form-control btn-default btn-outline">
														...
														<div class="form-group">
															<label class="control-label mb-10">Pilih Kecamatan</label>
															<select class="selectpicker" data-style="form-control btn-default btn-outline">
														...
														<div class="form-group">
															<label class="control-label mb-10">Pilih Kelurahan</label>
															<select class="selectpicker" data-style="form-control btn-default btn-outline">
														...
														<div class="form-group">
															<label class="control-label mb-10" for="exampleInputEmail_1">Biaya Registrasi</label>
															<div class="input-group">
																<div class="input-group-addon"><i class=""><b>Rp</b></i></div>
																<input type="number" class="form-control" id="exampleInputEmail_1" placeholder="Biaya Registrasi">
															</div>
														</div>
														<div class="form-group">
															<label class="control-label mb-10" for="exampleInputEmail_1">Total Hadiah</label>
															<div class="input-group">
																<div class="input-group-addon"><i class=""><b>Rp</b></i></div>
																<input type="number" class="form-control" id="exampleInputEmail_1" placeholder="Total Hadiah">
															</div>
														</div>
														<div class="form-group">
															<label class="control-label mb-10" for="exampleInputEmail_1">Jumlah Tim</label>
															<div class="input-group">
																<div class="input-group-addon"><i class="fa fa-group"></i></div>
																<input type="number" class="form-control" id="exampleInputEmail_1" placeholder="Jumlah Tim">
															</div>
														</div>
														<div class="form-group">
															<label class="control-label mb-10" for="exampleInputEmail_1">Link Sosial Media</label>
															<div class="input-group">
																<div class="input-group-addon"><i class="fa fa-link"></i></div>
																<input type="link" class="form-control" id="exampleInputEmail_1" placeholder="Sosial Media">
															</div>
														</div>
														<div class="form-group">
															<label class="control-label mb-10" for="exampleInputEmail_1">Link Pendaftaran</label>
															<div class="input-group">
																<div class="input-group-addon"><i class="fa fa-link"></i></div>
																<input type="link" class="form-control" id="exampleInputEmail_1" placeholder="Link Pendaftaran">
															</div>
														</div>
													</div>
												</div>
										...
										<h3><span class="number"><i class="icon-user-following txt-black"></i></span><span class="head-font capitalize-font">Data Panitia 1</span></h3>
										<fieldset>
											<div class="row">
												<div class="col-sm-12">
													<div class="form-wrap">
														<div class="form-group">
															<div class="row">
																<div class="col-md-6 col-xs-12">
																	<label class="control-label mb-10" for="firstName">Nama Depan:</label>
																	<input id="firstName" type="text" name="first_name" class="form-control " value="" />
																</div>
																<div class="span1"></div>
																<div class="col-md-6 col-xs-12">
																	<label class="control-label mb-10" for="lastName">Nama Belakang:</label>
																	<input id="lastName" type="text" name="last_name" class="form-control " value="" />
																</div>
															</div>
														</div>
														<div class="form-group">
															<label class="control-label mb-10" for="cityName">Jenis Kelamin:</label>
														...
														<div class="form-group">
															<label class="control-label mb-10" for="phoneNumber">No Telepon:</label>
															<input type="text" id="phoneNumber"  data-mask="+62 99 999 999 999" name="phone_number" class="form-control " value="" />
														</div>
														<div class="form-group">
															<label class="control-label mb-10" for="emailAddress">Alamat Email:</label>
															<input id="emailAddress" type="text" name="email_address" class="form-control " value="" />
														</div>
														<div class="form-group">
															<label class="control-label mb-10" for="addressDetail">Alamat:</label>
															<input id="addressDetail"  type="text" name="address" class="form-control " value="" />
														</div>
														<div class="form-group">
															<label class="control-label mb-10" for="cityName">Kota/Kabupaten:</label>
															<select id="cityName" class="form-control " name="country">
														...
														<div class="form-group">
															<label class="control-label mb-10" for="stateName">Kecamatan:</label>
														...
														<div class="form-group">
															<label class="control-label mb-10" for="stateName">Kelurahan:</label>
															<select id="stateName" class="form-control " name="country">
																<option value="">Karnataka</option>
																<option value="">Maharashtra</option>
															</select>
										...
										<h3><span class="number"><i class="icon-user-following txt-black"></i></span><span class="head-font capitalize-font">Data Panitia 2</span></h3>
										<fieldset>
											<div class="row">
												<div class="col-sm-12">
													<div class="form-wrap">
										...
										<h3><span class="number"><i class="icon-picture txt-black"></i></span><span class="head-font capitalize-font">Unggah Poster</span></h3>
										<fieldset>
												<div class="">
	...
	<script src="admin/dist/js/form-wizard-data.js"></script>
	
	<!-- Form Flie Upload Data JavaScript -->
	<script src="admin/dist/js/form-file-upload-data.js"></script>
	...
	<script src="admin/dist/js/form-picker-data.js"></script>
	...
	<script src="admin/dist/js/form-advance-data.js"></script>
	...
	<!-- Starrr JavaScript -->
	<script src="admin/dist/js/starrr.js"></script>
</body>
